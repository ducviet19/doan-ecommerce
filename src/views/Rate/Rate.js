...
function Rate(props) {
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col-md-2">
                                                    <img src={e.user.imageUser} className="img img-rounded img-fluid rounded-circle" />
                                                    <p className="text-secondary text-center">{e.timeDate.split("T")[0]}</p>
                                                </div>
                                                <div className="col-md-10">
                                                    <p>
                                                        <a className="float-left" href="https://maniruzzaman-akash.blogspot.com/p/contact.html"><strong>{e.user.displayName}</strong></a>
    ...
    useEffect(() => {
        dispatch(fetchReviews(props.product.documentID))
    }, [])
